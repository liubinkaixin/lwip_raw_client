...
//LAN8720 PHYÐ¾Æ¬µÄ×´Ì¬¼Ä´æÆ÷
#define PHY_SR				((uint16_t)31) 		//LAN8720µÄPHY×´Ì¬¼Ä´æÆ÷µØÖ·
#define PHY_SPEED_STATUS    ((uint16_t)0x0004) 	//LAN8720 PHYËÙ¶ÈÖµÑÚÂë
#define PHY_DUPLEX_STATUS   ((uint16_t)0x00010) //LAN8720 PHYÁ¬½Ó×´Ì¬ÖµÑÚÂë 

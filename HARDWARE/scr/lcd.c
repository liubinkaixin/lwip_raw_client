...
u16 POINT_COLOR=0x0000;	//前景颜色默认黑色
u16 BACK_COLOR=0xFFFF;  //背景颜色默认白色
_lcd_dev lcddev;        //lcd的管理蚕参数
...
/*参  数：x,y:起始坐标                             */
/*参  数：num:要显示的字符                         */
/*参  数：size:字体大小 12/16/24                   */
/*参  数：mode:叠加方式(1)还是非叠加方式(0)        */
/*返回值：无                                       */ 
/*-------------------------------------------------*/
